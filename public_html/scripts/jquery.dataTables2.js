...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			if ( oSettings.aLengthMenu.length == 2 && typeof oSettings.aLengthMenu[0] == '' && 
					typeof oSettings.aLengthMenu[1] == '' )
			{
